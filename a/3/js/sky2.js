class sky2
{
    constructor(gl, n)
    {
        ...
        this.n = n;
        this.index_array = [];
        this.lib.gl_start.call(this, "sky2.vert", "sky2.frag", 0);
    }
    ...
    draw_mesh(u_project, u_view, texture_src)
    {
        if(texture_src)
        {
            ...
            if(this.uBgColor >= 0)
                this.gl.uniform3fv(this.uBgColor, false, [.89,.81,.75]);
            if(this.uMaterial >= 0)
            ...
            if(this.aPos >= 0)
            {
                ...
                this.gl.vertexAttribPointer(this.aPos, 3, this.gl.FLOAT, false, vertex_n * bpe,  0 * bpe);
            }
            if(this.aNor >= 0)
            {
            ...
            this.gl.drawArrays(this.gl.TRIANGLE_STRIP, 0, this.vertices.length / vertex_n);
