class wave
{
    ...
    wave()
    {
        ...
        this.frame_i = window.requestAnimationFrame(callback); /* update animation onscreen */
    };
    ...
    draw_mesh()
    {
        ...
        matrixLookAt(this.camera.position, this.camera.look_at, this.camera.up, this.u_view);
