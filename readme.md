...
random number generator}\\
  \mathbf{d}(\mathbf{x}, t) = \sum -i \frac{K}{k} \widetilde{h}(K, t) e ^ {ikx} \quad \text{the 2d displacement vector field is computed using the fourier amplitudes of the height field}\\
}
```
